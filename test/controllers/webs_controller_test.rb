...
class WebsControllerTest < ActionController::TestCase
  ...
  test "should create web" do
    assert_difference('Web.count') do
      post :create, web: { deleted_at: @web.deleted_at, facebook: @web.facebook, hatena: @web.hatena, html: @web.html, name: @web.name, twitter: @web.twitter, url: @web.url }
    end
  ...
  test "should update web" do
    patch :update, id: @web, web: { deleted_at: @web.deleted_at, facebook: @web.facebook, hatena: @web.hatena, html: @web.html, name: @web.name, twitter: @web.twitter, url: @web.url }
    assert_redirected_to web_path(assigns(:web))
  end
